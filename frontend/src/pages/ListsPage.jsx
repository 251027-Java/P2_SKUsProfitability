        ...
        <div>
            <div className="mb-10">
                <div className="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <p className="text-gray-600 text-lg">Organize your favorite SKUs into lists</p>
                    </div>
                    <button
            ...
            {loading ? (
                <div className="p-16 text-center">
                    ...
                    <p className="mt-4 text-gray-600 font-medium">Loading lists...</p>
                </div>
            ) : lists.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-16 text-center">
                    ...
                    <p className="text-gray-600 mb-6">Create your first list to organize your SKUs</p>
                    <button
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold text-gray-900 mb-4">Your Lists</h2>
                        {lists.map((list) => (
                            <div
                                key={list.listId}
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            {selectedList.items && selectedList.items.length > 0 ? (
                                        ...
                                        <tbody className="divide-y divide-gray-100">
                                            {selectedList.items.map((sku) => (
                                                <tr key={sku.skuId} className="hover:bg-gray-50 transition-colors duration-150">
                                                    <td className="px-4 py-3 text-sm font-semibold text-gray-900">{sku.sku}</td>
                                                    <td className="px-4 py-3 text-sm text-gray-900">{sku.productName || '-'}</td>
                                                    <td className="px-4 py-3 text-sm font-medium text-gray-900">${parseFloat(sku.sellingPrice || 0).toFixed(2)}</td>
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-600 font-medium">This list is empty</p>
                                    <p className="text-sm text-gray-500 mt-1">Add SKUs from the My SKUs section</p>
                                </div>
                            )}
                        </div>
                    )}
